...
public class vehicle_list extends AppCompatActivity {
    ...
    private String sourse,destination;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourse = intent.getExtras().getString("Sourse");
        destination=intent.getExtras().getString("Destination");

        Log.d("Sourse","Sourse : "+sourse);
   ...
   private void view() {
      ...
      final Retrofit retrofit = RetrofitApi.getRetrofitApi();
       ...
       Call<List<Vehicle_Details>> employeeCall = customerApi.viewVehicle(sourse,destination);
